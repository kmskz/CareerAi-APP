...
# Pretty thick divider



# ---------------- Persist resume skills ----------------
...
sidebar_option = st.sidebar.selectbox(
    "Navigate",
    ["Career Suggestor", "Career Developer", "Career Journal"]
)

# ---------------- Career Journal ----------------
if sidebar_option == "Career Journal":
    st.header("My Career Journal")
    entry = st.text_area("Today’s reflection...[Date:Reflection]", key="journal_textarea")
    #if st.button("Save Entry", key="save_journal"):
     #   if entry.strip():
      #      save_journal_entry(entry)
       #     st.success("Entry saved to Firestore!")
...
# ---------------- Career Suggestor ----------------
    ...
    # Aptitude score input (text box instead of spinner)
    ...
    # If user doesn’t know their score → show test link
